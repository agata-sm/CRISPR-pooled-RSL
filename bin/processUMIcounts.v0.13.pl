...
# Guide	Gene	Sequence
# A1BG_1	A1BG	CATCTTCTTTCACCTGAACG
# A1BG_2	A1BG	CTCCGGGGAGAACTCCGGCG
...
my $script_name="processUMIcounts.v0.12.pl";
...
if ($ARGV[0]eq qw '-h'){
	...
	print "--input_lib_design: /path/to/file with library design Library.tsv; tab delimited: Guide - Gene - Sequence\n";	#UMICount_Brunello_Library_USE_THIS_ONLY.tsv
