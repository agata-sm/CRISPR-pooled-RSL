...
if (length(args) < 7) stop("Not all args are set; required: projdir proj.name.prefix data.type organism (hs or mm) metadata.fname comparisons.fname scatters.fname")
