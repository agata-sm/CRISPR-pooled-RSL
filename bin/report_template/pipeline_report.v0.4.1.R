...
if (scatters.fname !="NULL"){
  ...
  if (scatters.fname!="none"){
  
  if (file.exists(scatters.fname)){
      ...
      for (i in c(1:nrow(scatters_df))) {
        ...
        print("scatters.txt file does not exist; no scatter plots generated")
    }
  
  }else{
    print("no scatter plots generated")
  }
...
## ---- this_below_is_outdated - the code above is used now
