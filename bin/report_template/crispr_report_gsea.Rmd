...
figurecap.gseapl=paste("GSEA plots visualise results of gene set enrichment analysis in comparison ",i,"; genes under ",selection," selection. Shown are top 6 categories (by FDR): ",sel_cat_caption,". Rank in ordered data set - reverse RRA " ,selection," rank.",sep="")
figurecap.heatpl.lfc=paste("Heatmap to display relationships between gene abundance and functional category membership in comparison ",i,"; genes under ",selection," selection.",sep="")
...
```{asis, eval=!is.RSL, echo=print_plots}
Relationships between gene abundance and functional category membership are visualised as a heatmap.
```

```{asis, eval=is.RSL, echo=print_plots}
Relationships between effect size (RRA pathway score) and functional category membership are visualised as a heatmap.
```
...
if (data.type == "reads"){
	...
	figurecap.heatpl=figurecap.heatpl.rra
}
```
