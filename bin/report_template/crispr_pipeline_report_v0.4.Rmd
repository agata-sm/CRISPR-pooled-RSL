...
Table \@ref(tab:data-countingstats-table) presents summary statistics of sgRNA quantification. Total number of sgRNAs in the library was n=`r summary.stats[1,6]`.
