...
# script to install pandoc required for generation reports by CRISPR-pooled-RSL pipeline
# based on intstall_pandoc.sh from https://github.com/rocker-org/rocker-versioned2
# used in images based on rocker/tidyverse:4.2.1


set -e

#this has been set manually due to earlier tests
